package com.example.healthcorner.utility;
...
public class RingtonePlayingService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        if(!this.isRunning && startId == 1) {
            ...
            if (random_number == 1) {
                mMediaPlayer = MediaPlayer.create(this, R.raw.ring01);
            }
            else if (random_number == 2) {
                mMediaPlayer = MediaPlayer.create(this, R.raw.ring02);
            }
            else if (random_number == 3) {
                mMediaPlayer = MediaPlayer.create(this, R.raw.ring03);
            }
            else {
                mMediaPlayer = MediaPlayer.create(this, R.raw.ring01);
            }
